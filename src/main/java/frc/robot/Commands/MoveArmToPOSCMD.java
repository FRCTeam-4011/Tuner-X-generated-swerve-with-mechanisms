...
public class MoveArmToPOSCMD extends Command {
  /** Creates a new MoveArmToPodShotCMD. */
  private final ArmSubsystem armSubsystem;
  private double armVolts;

  public MoveArmToPOSCMD(ArmSubsystem armSubsystem, double armVolts) {
  ...
  public boolean isFinished() {
    if (armSubsystem.getArmEncoderPOS() <= EncoderConstants.ek_PodiumShotArmPOS) {
      return true;
    } else {
      return false;
    }
