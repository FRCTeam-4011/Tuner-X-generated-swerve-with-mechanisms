...
public class MoveArmToAmpCMD extends Command {
  /** Creates a new ArmHomeCommand. */
  private final ArmSubsystem armSubsystem;
  private double armVolts;

  public MoveArmToAmpCMD(ArmSubsystem armSubsystem, double armVolts) {
  ...
  public void initialize() {
    System.out.println("Arm Home CommandStarted");
  }
  ...
  public void end(boolean interrupted) {
    ...
    System.out.println("Arm down cmd done");
  }
